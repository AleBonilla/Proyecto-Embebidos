## Proyecto de Sistemas Embebidos: Sistema de registro del número de usuario para enviar una imagen desde la Raspberry a Telegram mediante el uso de NodeRed
